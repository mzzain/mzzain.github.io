    ...
    kursSelect.addEventListener("change", function() {
      ...
      const formatharga = formatRp(passenger.value * 503000);
      ...
      const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        hargavalas.value = "$ " + Math.ceil(passenger.value * 503000 / kursusd.value);
      ...
      const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "S$ " + Math.ceil(passenger.value * 503000 / kurssgd.value);
        convert.value = formatkonversi;
 ...
 const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "HK$ " + Math.ceil(passenger.value * 503000 / kurshkd.value);
        convert.value = formatkonversi;
      ...
      const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "€ " + Math.ceil(passenger.value * 503000 / kurseur.value);
        convert.value = formatkonversi;
        matauang.value = "EURO";
      ...
      const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "¥ " + Math.ceil(passenger.value * 503000 / kursjpy.value);
        convert.value = formatkonversi;
      ...
      const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "£ " + Math.ceil(passenger.value * 503000 / kursgbp.value);
        convert.value = formatkonversi;
 ...
 const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "﷼ " + Math.ceil(passenger.value * 503000 / kurssar.value);
        convert.value = formatkonversi;
 ...
 const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "A$ " + Math.ceil(passenger.value * 503000 / kursaud.value);
        convert.value = formatkonversi;
      ...
      const changefix = formatRp(konversinumber -harganumber - pembulatan + 500);
        ...
        harga.value = formatharga;
        hargavalas.value = "฿ " + Math.ceil(passenger.value * 503000 / kursthb.value);
        convert.value = formatkonversi;
      ...
      const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "RM " + Math.ceil(passenger.value * 503000 / kursmyr.value);
        convert.value = formatkonversi;
     ...
     if(bulat.value > 500){
      ...
      const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "CN¥ " + Math.ceil(passenger.value * 503000 / kurscny.value);
        convert.value = formatkonversi;
 ...
 const changeround = formatRp(konversinumber -harganumber - pembulatan);
  ...
  <div id="receipt" style="width:68mm; font-family: sans-serif; font-size:18px; padding:2px;">
    <div style="text-align:center;">
      <h3 style="margin:0;">VISA ON ARRIVAL</h3>
      <p style="margin:0;">Voucher </p>
      <hr>
    </div >
    <p style="text-align:center; font-size:14px">Date: ${new Date().toLocaleString('us-ID')}</p>
    <p style="text-align:center"> Rp. 503.000/Person </p>
     <table style="width:100%; font-size:16px;">
      <tr>
        <td style="height:25px; width:112px"">Currency</td>
        <td>:</td>
        <td style="text-align:right;font-size:13px">${currency}</td>
      </tr>
      <tr>
        <td style="height:25px">Exchange Rate</td>
        <td>:</td>
        <td style="text-align:right;">${kurs}</td>
      </tr>
      <tr>
        <td style="height:25px">Passengers</td>
        <td>:</td>
  ...
  <br>
    ...
    <table style="width:100%; font-size:16px;">
      ...
      <tr>
        <td style="font-size:13px">${currency}</td>
        <td >:</td>
    ...
    <div style="text-align:center;font-size:14px;">
      <p style="margin:2;">Thank you!</p>
      <p style="margin:2;">Have a nice day</p>
    </div>
  </div>
  `;
