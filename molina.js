...
document.querySelector(".Kurs").addEventListener("change", updateKursPilih);

Object.values(mapKurs).forEach(id => {
  document.getElementById(id).addEventListener("input", () => {
    
    // update localStorage
    localStorage.setItem(id, document.getElementById(id).value);

    // update kurspilih jika yg dipilih sama
    updateKursPilih();
  });
});
...
function updateKursPilih() {
  const select = document.querySelector(".Kurs").value;
  const idInput = mapKurs[select];

  const nilai = document.getElementById(idInput).value;
  document.getElementById("kurspilih").value = nilai;
}  
  const semuaKurs = [
...
const kursSelect = document.querySelector(".Kurs");
    ...
    kursSelect.addEventListener("change", function() {
      ...
      const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        hargavalas.value = "$ " + Math.ceil(passenger.value * 513500 / kursusd.value);
      ...
      const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "S$ " + Math.ceil(passenger.value * 513500 / kurssgd.value);
        convert.value = formatkonversi;
 ...
 const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "HK$ " + Math.ceil(passenger.value * 513500 / kurshkd.value);
        convert.value = formatkonversi;
      ...
      const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "€ " + Math.ceil(passenger.value * 513500 / kurseur.value);
        convert.value = formatkonversi;
        matauang.value = "EURO";
      ...
      const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "¥ " + Math.ceil(passenger.value * 513500 / kursjpy.value);
        convert.value = formatkonversi;
      ...
      const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "£ " + Math.ceil(passenger.value * 513500 / kursgbp.value);
        convert.value = formatkonversi;
 ...
 const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "﷼ " + Math.ceil(passenger.value * 513500 / kurssar.value);
        convert.value = formatkonversi;
 ...
 const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "A$ " + Math.ceil(passenger.value * 513500 / kursaud.value);
        convert.value = formatkonversi;
      ...
      const changefix = formatRp(konversinumber -harganumber - pembulatan + 500);
        ...
        harga.value = formatharga;
        hargavalas.value = "฿ " + Math.ceil(passenger.value * 513500 / kursthb.value);
        convert.value = formatkonversi;
      ...
      const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "RM " + Math.ceil(passenger.value * 513500 / kursmyr.value);
        convert.value = formatkonversi;
     ...
     if(bulat.value > 500){
      ...
      const changeround = formatRp(konversinumber -harganumber - pembulatan);
        ...
        harga.value = formatharga;
        hargavalas.value = "CN¥ " + Math.ceil(passenger.value * 513500 / kurscny.value);
        convert.value = formatkonversi;
